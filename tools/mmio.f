      subroutine mmread2(iunit,rep,field,symm,rows,cols,nnz,nnzmax,
...
c
c The unit iunit must be open, and header is preread by a call to
c mminfo
c
...
c         
c   rep     character*10 in  Matrix Market 'representation' 
...
c                                   
c   field   character*7  in  Matrix Market 'field'. On return:
c                                   
c                                real 
c                                complex
c                                integer
c                                pattern
c                                   
c   symm    character*19 in  Matrix Market 'field'. On return:
c                                   
c                                symmetric
c                                hermitian
c                                skew-symmetric
...
c         
c   nnz      integer     in  Number of nonzero entries required to
c                             store matrix.
c         
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc      
      ...
      subroutine mminfo2(iunit,rep,field,symm,rows,cols,nnz)
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc      
c
c This routine will read header information from a Matrix Market 
c formatted file.  
c
c The unit iunit must be open, file is not rewound after parse.
c
c 20-Sept-96  Karin A. Remington, NIST ACMD (karin@cam.nist.gov)
c 18-Oct-96   Change in routine name to match C and Matlab routines.
c 30-Oct-96   Bug fixes in mmio.f:
