...
C         Copyright 2006, Umeå University, Sweden.                     C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      SUBROUTINE ILAPRNT( M, N, A, IA, JA, LDA, CMATNM, NOUT )
C
C  -- ScaLAPACK-style routine (preliminary version ) --
C     HPC2N and Department of Computing Science,
C     University of Umeå, Sweden.
...
C         Copyright 2006, Umeå University, Sweden.                     C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      SUBROUTINE DLAPRNT2( M, N, A, IA, JA, LDA, CMATNM, NOUT, 
     $        ITER1, ITER2 )
C
C  -- ScaLAPACK-style routine (preliminary version ) --
C     HPC2N and Department of Computing Science,
...
C
C     .. Scalar Arguments ..
      INTEGER            IA, JA, M, N, NOUT, LDA, ITER1, ITER2
C     ..
C     .. Array Arguments ..
      CHARACTER*(*)      CMATNM
      DOUBLE PRECISION   A( * )
...
C
      ...
      DO 10 I = IA, IA+M-1
         DO 20 J = JA, JA+N-1
            ...
            IF (ITER1.GT.9) THEN
                  IF (ITER2.GT.9) THEN
                     WRITE( NOUT, FMT = 9997 )
     $                  CMATNM, ITER1, ITER2, I, J, A( INDEX )
                  ELSE 
                     WRITE( NOUT, FMT = 9998 )
     $                  CMATNM, ITER1, ITER2, I, J, A( INDEX )
                  END IF 
     ...
     $                  CMATNM, ITER1, ITER2, I, J, A( INDEX )
                  ELSE 
                     WRITE( NOUT, FMT = 9999 )
     $                  CMATNM, 0, ITER1, ITER2, I, J, A( INDEX )
                  END IF 
            END IF
...
C     
 ...
 9997 FORMAT(A,I2,I2,'(',I6,',',I6,')=',D30.18,';')
 9996 FORMAT(A,I1,I2,'(',I6,',',I6,')=',D30.18,';')
...
C     
      END
C     
      SUBROUTINE ILAPRNT2( M, N, A, IA, JA, LDA, CMATNM, NOUT, 
     $        ITER1, ITER2 )
C
C  -- ScaLAPACK-style routine (preliminary version ) --
C     HPC2N and Department of Computing Science,
...
C
 ...
 10   CONTINUE
C     
 9999 FORMAT(A,I1,I1,I1,'(',I6,',',I6,')=',I4,';')
 9998 FORMAT(A,I2,I1,'(',I6,',',I6,')=',I4,';')      
 9997 FORMAT(A,I2,I2,'(',I6,',',I6,')=',I4,';')
 9996 FORMAT(A,I1,I2,'(',I6,',',I6,')=',I4,';')
C     
      RETURN
C     
      END
