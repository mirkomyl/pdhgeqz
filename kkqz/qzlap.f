      SUBROUTINE QZLAP( JOB, COMPQ, COMPZ, N, ILO, IHI, A, LDA, B, LDB,
     $   ALPHAR, ALPHAI, BETA, Q, LDQ, Z, LDZ, WORK,
     $   LWORK, INFO )
      IMPLICIT NONE
*     
*     This is a slightly modified version of the LAPACK routine DHGEQZ.
*     
*     .. Scalar Arguments ..
...
c     ULP = DLAMCH( 'E' )*DLAMCH( 'B' )
      ...
      BTOL = MAX( SAFMIN, PARA_INFTOL*BNORM )
...
*           
            IF( J.EQ.ILO ) THEN
               ILAZRO = .TRUE.
            ELSE
*              Modification: Use componentwise deflation criterium if desired.
